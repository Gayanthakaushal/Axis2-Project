...
import net.webservicex.www.GetQuoteDocument.GetQuote;

public class MyStockQuoteSkeleton implements GetQuote {
	...
	public void xsetSymbol(XmlString symbol) {
		// TODO Auto-generated method stub
